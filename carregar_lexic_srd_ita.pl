...
my $HOME = '/home/gianfranco';
open($fdixita, "$HOME/Scrivania/apertium-ita/apertium-ita.ita.dix") || die "can't open apertium-ita.ita.dix: $!";
open($fdixitan, "$HOME/Scrivania/apertium-ita/jaumeortola/ita-noun.txt") || die "can't open ita-noun.txt: $!";
open($fdixitaadj, "$HOME/Scrivania/apertium-ita/jaumeortola/ita-adj.txt") || die "can't open ita-adj.txt: $!";
open($fdixitaadv, "$HOME/Scrivania/apertium-ita/jaumeortola/ita-adv.txt") || die "can't open ita-adv.txt: $!";
open($fdixsrd, "$HOME/Scrivania/apertium-srd/apertium-srd.srd.dix") || die "can't open apertium-srd.srd.dix: $!";
open($fdixbi, "$HOME/apertium-srd-ita/apertium-srd-ita.srd-ita.dix") || die "can't open apertium-srd-ita.srd-ita.dix: $!";
